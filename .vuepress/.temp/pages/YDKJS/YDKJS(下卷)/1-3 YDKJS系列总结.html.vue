<template><div><h1 id="深入-你不知道的javascript系列" tabindex="-1"><a class="header-anchor" href="#深入-你不知道的javascript系列"><span>深入“你不知道的JavaScript系列”</span></a></h1>
<p>简单地说，《你不知道的JavaScript系列》这个系列视学习<strong>全部的 JavaScript</strong> 为一个严肃的任务，不仅仅是这门语言中被称为“精髓”的某个子集，也不是你完成工作所需要的最小集合。</p>
<h2 id="作用域与闭包" tabindex="-1"><a class="header-anchor" href="#作用域与闭包"><span>作用域与闭包</span></a></h2>
...
<h2 id="this-和对象原型" tabindex="-1"><a class="header-anchor" href="#this-和对象原型"><span>this 和对象原型</span></a></h2>
...
<h2 id="类型和语法" tabindex="-1"><a class="header-anchor" href="#类型和语法"><span>类型和语法</span></a></h2>
<p>“类型和语法”这部分主要关注另一个高度争议的主题:强制类型转换。</p>
<p>类型转换是非常有用且被低估了的工具，你应该在自己的代码中使用它。在我看来，如果能够正确使用的话，类型转换不仅能够工作，而且也会让你的代码质量更高。</p>
<h2 id="异步和性能" tabindex="-1"><a class="header-anchor" href="#异步和性能"><span>异步和性能</span></a></h2>
...
<h2 id="es6-及更新版本" tabindex="-1"><a class="header-anchor" href="#es6-及更新版本"><span>ES6 及更新版本</span></a></h2>
<p>参考本书第二部分。</p>
