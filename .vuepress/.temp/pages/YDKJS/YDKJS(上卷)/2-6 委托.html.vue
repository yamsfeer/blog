<template><div><h1 id="委托" tabindex="-1"><a class="header-anchor" href="#委托"><span>委托</span></a></h1>
<blockquote>
<p>[[Prototype]]机制是指对象的一个内部链接引用另一个对象。</p>
<p><strong>这个机制的本质是对象间的关联关系。</strong></p>
</blockquote>
<h2 id="面向委托的设计" tabindex="-1"><a class="header-anchor" href="#面向委托的设计"><span>面向委托的设计</span></a></h2>
...
<div class="language-javascript" data-ext="js" data-title="js"><pre v-pre class="language-javascript"><code><span class="token keyword">class</span> <span class="token class-name">Task</span> <span class="token punctuation">{</span>
...
<span class="token punctuation">}</span>
</code></pre></div><h3 id="委托理论" tabindex="-1"><a class="header-anchor" href="#委托理论"><span>委托理论</span></a></h3>
<div class="language-javascript" data-ext="js" data-title="js"><pre v-pre class="language-javascript"><code><span class="token keyword">const</span> Task <span class="token operator">=</span> <span class="token punctuation">{</span>
...
<h3 id="两者比较-委托更简洁" tabindex="-1"><a class="header-anchor" href="#两者比较-委托更简洁"><span>两者比较：委托更简洁</span></a></h3>
<p>参考以下两段代码：</p>
<ul>
<li>
<p>典型的基于原型的面向对象</p>
<div class="language-javascript" data-ext="js" data-title="js"><pre v-pre class="language-javascript"><code><span class="token keyword">function</span> <span class="token function">Foo</span><span class="token punctuation">(</span><span class="token parameter">who</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
...
</code></pre></div><p>因为<code v-pre>原型、prototype属性、constructor</code>等的指向关系，</p>
<p>使得<code v-pre>Foo、Bar、Foo.prototype、Bar.prototype、Function、Function.prototype、Object.prototype</code>间的关系变得非常复杂。</p>
<p>(仔细整理一下下图的节点排列位置有利于看清它们间的关系。)</p>
<Mermaid id="mermaid-115" code=""></Mermaid></li>
<li>
<p>委托风格</p>
<div class="language-javascript" data-ext="js" data-title="js"><pre v-pre class="language-javascript"><code><span class="token keyword">const</span> Foo <span class="token operator">=</span> <span class="token punctuation">{</span>
...
b1<span class="token punctuation">.</span><span class="token function">speak</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
b2<span class="token punctuation">.</span><span class="token function">speak</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
</code></pre></div><p>通过比较可以看出，对象关联风格的代码显然更加简洁，因为这种代码只关注一件事：<strong>对象之间的关联关系</strong>。</p>
<p>其他的“类”技巧都是非常复杂并且令人困惑的。去掉它们之后，事情会变得简单许多 (同时保留所有功能)。</p>
<Mermaid id="mermaid-128" code="eJxLL0osyFDwCeJySiyKBuKn63e+2LgwVkFXt0Kh5mnf/Kfzumvc8vOjgRgqxQVkAqXt4NL+SVmpySUBRfkl+dEQtl4BiFNSWZAay8WVZBidZAgyEKEDaA9XklF0khGmMAC7ADyh"></Mermaid></li>
</ul>
<h2 id="类与委托实现控件-按钮控件实例" tabindex="-1"><a class="header-anchor" href="#类与委托实现控件-按钮控件实例"><span>类与委托实现控件（按钮控件实例）</span></a></h2>
<h3 id="控件-类-实现" tabindex="-1"><a class="header-anchor" href="#控件-类-实现"><span>控件“类”实现</span></a></h3>
<div class="language-javascript" data-ext="js" data-title="js"><pre v-pre class="language-javascript"><code><span class="token comment">// 父类</span>
...
</code></pre></div><div class="language-javascript" data-ext="js" data-title="js"><pre v-pre class="language-javascript"><code><span class="token keyword">class</span> <span class="token class-name">Widget</span> <span class="token punctuation">{</span>
...
<span class="token keyword">class</span> <span class="token class-name">Button</span> <span class="token keyword">extends</span> <span class="token class-name">Widget</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre></div><p>使用“基于原型的继承“代码中，除了有上一小节提到的关系混乱的缺点外，还有伪多态带来的麻烦，</p>
<p>比如<code v-pre>Widget. prototype.render.call</code> 从“子类”方法中引用“父类”中的基础方法。</p>
<p>在ES6的代码中<code v-pre>super函数</code>缓解了这个问题，但是这里并没有真正的类，<strong>class 仍然是通过 [[Prototype]] 机制实现的</strong>。</p>
<p>无论你使用的是传统的原型语法还是 ES6 中的新语法糖，你仍然需要用“类”的概念来对问题(UI 控件)进行建模。</p>
<h3 id="委托对象实现" tabindex="-1"><a class="header-anchor" href="#委托对象实现"><span>委托对象实现</span></a></h3>
<div class="language-javascript" data-ext="js" data-title="js"><pre v-pre class="language-javascript"><code><span class="token keyword">var</span> Widget <span class="token operator">=</span> <span class="token punctuation">{</span>
...
</code></pre></div><p>同样地，我们建议在委托与被委托者间尽量不用同名函数，比如 <code v-pre>insert / build</code>，<code v-pre>init / setup</code>。</p>
<p>另外，与“类”实现相比，委托实现在调用<code v-pre>setup</code>函数前，不会被初始化。</p>
<p><strong>对象关联可以更好地支持关注分离(separation of concerns)原则，创建和初始化并不需要合并为一个步骤。</strong></p>
<h3 id="更简洁的代码-登录和验证实例" tabindex="-1"><a class="header-anchor" href="#更简洁的代码-登录和验证实例"><span>更简洁的代码（登录和验证实例）</span></a></h3>
...
<h4 id="类方法" tabindex="-1"><a class="header-anchor" href="#类方法"><span>“类方法”</span></a></h4>
<div class="language-javascript" data-ext="js" data-title="js"><pre v-pre class="language-javascript"><code><span class="token comment">// 父类</span>
...
</code></pre></div><p>AuthController 需要使用 LoginController，因此我们实例化后者(new LoginController)并用一个类成员属性 this.login 来引用它，这样 AuthController 就可以调用 LoginController 的行为。</p>
...
<h4 id="委托-1" tabindex="-1"><a class="header-anchor" href="#委托-1"><span>委托</span></a></h4>
<div class="language-javascript" data-ext="js" data-title="js"><pre v-pre class="language-javascript"><code><span class="token keyword">var</span> LoginController <span class="token operator">=</span> <span class="token punctuation">{</span>
...
</code></pre></div><p>在行为委托模式中，AuthController 和 LoginController 只是对象，它们之间是兄弟关系， 并不是父类和子类的关系。</p>
...
<h2 id="es6简洁语法" tabindex="-1"><a class="header-anchor" href="#es6简洁语法"><span>ES6简洁语法</span></a></h2>
<p>可以利用ES6中的<code v-pre>Object.setPrototypeOf</code>来设置原型，替代原本的<code v-pre>Object.create</code>。</p>
<div class="language-javascript" data-ext="js" data-title="js"><pre v-pre class="language-javascript"><code><span class="token keyword">let</span> AuthController <span class="token operator">=</span> <span class="token punctuation">{</span>
  <span class="token comment">// ...</span>
<span class="token punctuation">}</span>
...
</code></pre></div><p>ES6函数简洁语法的一个缺点：</p>
<div class="language-javascript" data-ext="js" data-title="js"><pre v-pre class="language-javascript"><code><span class="token keyword">var</span> Foo <span class="token operator">=</span> <span class="token punctuation">{</span>
...
<span class="token keyword">var</span> Foo <span class="token operator">=</span> <span class="token punctuation">{</span>
  ...
  <span class="token function-variable function">baz</span><span class="token operator">:</span> <span class="token keyword">function</span> <span class="token function">baz</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span><span class="token punctuation">}</span>
<span class="token punctuation">}</span><span class="token punctuation">;</span>
</code></pre></div><p>匿名函数没有 name 标识符，这会导致:</p>
<ol>
<li>调试栈更难追踪;</li>
...
<div class="language-javascript" data-ext="js" data-title="js"><pre v-pre class="language-javascript"><code><span class="token keyword">var</span> Foo <span class="token operator">=</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span><span class="token punctuation">;</span>
</code></pre></div><h2 id="内省-判断a是否是b的实例或原型" tabindex="-1"><a class="header-anchor" href="#内省-判断a是否是b的实例或原型"><span>内省(判断a是否是b的实例或原型)</span></a></h2>
<p>在面向类的程序中，内省的意思是检查实例的类型。</p>
<p>类实例的自省主要目的是通过创建方式来判断对象的结构和功能。</p>
<p>判断方法：</p>
<ul>
<li>
<p>第五章提到了<code v-pre>instanceof</code>操作符，这不是一个好的方法，容易让人误解。</p>
</li>
<li>
<p>鸭子类型，比如promise会有then方法，但有then方法的对象不一定是promise对象。</p>
</li>
<li>
<p><code v-pre>a.isPrototypeOf(b)</code>，这个方法回答a是否在b的原型链上。</p>
<div class="language-javascript" data-ext="js" data-title="js"><pre v-pre class="language-javascript"><code><span class="token keyword">var</span> Foo <span class="token operator">=</span> <span class="token punctuation">{</span><span class="token punctuation">}</span><span class="token punctuation">;</span>
