<template><div><h1 id="值" tabindex="-1"><a class="header-anchor" href="#值"><span>值</span></a></h1>
...
</code></pre></div><h3 id="类数组" tabindex="-1"><a class="header-anchor" href="#类数组"><span>类数组</span></a></h3>
...
<div class="language-javascript" data-ext="js" data-title="js"><pre v-pre class="language-javascript"><code><span class="token keyword">var</span> nodes <span class="token operator">=</span> document<span class="token punctuation">.</span><span class="token function">querySelectorAll</span><span class="token punctuation">(</span><span class="token string">'.class'</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
...
</code></pre></div><p>一些数组函数可以用于将类数组转为数组，比如：<code v-pre>Array.prototype.slice.call( arguments )</code>、<code v-pre>Array.from( arguments )</code>；</p>
...
<div class="language-javascript" data-ext="js" data-title="js"><pre v-pre class="language-javascript"><code><span class="token keyword">var</span> a <span class="token operator">=</span> <span class="token string">'foo'</span>
...
<li>
<p>字符串可借用数组的一些函数</p>
<div class="language-javascript" data-ext="js" data-title="js"><pre v-pre class="language-javascript"><code><span class="token keyword">var</span> a <span class="token operator">=</span> <span class="token string">'foo'</span><span class="token punctuation">;</span>
...
<h2 id="数字" tabindex="-1"><a class="header-anchor" href="#数字"><span>数字</span></a></h2>
<p>**JavaScript 没有真正意义上的整数，只有数值类型number。**包括“整数”和带小数的十进制数。</p>
<p>JavaScript 中的“整数”就是没有小数的十进制数。所以 42.0 即等同于“整数”42。</p>
<p>与大部分现代编程语言(包括几乎所有的脚本语言)一样，JavaScript 中的数字类型是基于 <a href="https://www.zhihu.com/question/21711083" target="_blank" rel="noopener noreferrer">IEEE754<ExternalLinkIcon/></a> 标准来实现的，该标准通常也被称为“浮点数”。</p>
<p>JavaScript 使用的是“双精度”格式(即 64 位二进制)。</p>
<h3 id="数字的语法" tabindex="-1"><a class="header-anchor" href="#数字的语法"><span>数字的语法</span></a></h3>
<ul>
<li>
<p>数字的一些写法</p>
<div class="language-javascript" data-ext="js" data-title="js"><pre v-pre class="language-javascript"><code><span class="token keyword">var</span> num <span class="token operator">=</span> <span class="token number">42.0</span>
...
<li>
<p>数字的相关函数</p>
<div class="language-javascript" data-ext="js" data-title="js"><pre v-pre class="language-javascript"><code><span class="token comment">// Number.prototype.toExponential</span>
...
</code></pre></div><div class="language-javascript" data-ext="js" data-title="js"><pre v-pre class="language-javascript"><code><span class="token comment">// Number.prototype.toFixed</span>
...
<li>
<p>其他进制</p>
<div class="language-javascript" data-ext="js" data-title="js"><pre v-pre class="language-javascript"><code><span class="token number">243</span><span class="token punctuation">;</span> <span class="token comment">// 243的十进制</span>
...
<h3 id="较小的数值" tabindex="-1"><a class="header-anchor" href="#较小的数值"><span>较小的数值</span></a></h3>
<p>二进制浮点数最大的问题(不仅 JavaScript，所有遵循 IEEE 754 规范的语言都是如此)，是会出现如下情况:</p>
<div class="language-javascript" data-ext="js" data-title="js"><pre v-pre class="language-javascript"><code><span class="token number">0.1</span> <span class="token operator">+</span> <span class="token number">0.2</span> <span class="token operator">===</span> <span class="token number">0.3</span> <span class="token comment">// false</span>
</code></pre></div><p>简单来说，<strong>二进制浮点数中的 0.1 和 0.2 并不是十分精确</strong>，它们相加的结果并非刚好等于 0.3，而是一个比较接近的数字 0.30000000000000004，所以条件判断结果为 false。</p>
<p>最常见的方法是<strong>设置一个误差范围值，通常称为“机器精度”(machine epsilon)</strong>，对JavaScript 的数字来说，这个值通常是 2^-52 (2.220446049250313e-16)。</p>
<div class="language-javascript" data-ext="js" data-title="js"><pre v-pre class="language-javascript"><code><span class="token comment">// ES6版本前的兼容</span>
...
</code></pre></div><div class="language-javascript" data-ext="js" data-title="js"><pre v-pre class="language-javascript"><code><span class="token comment">// 最大浮点数</span>
...
</code></pre></div><h3 id="整数的安全范围" tabindex="-1"><a class="header-anchor" href="#整数的安全范围"><span>整数的安全范围</span></a></h3>
<p>数字的呈现方式决定了“整数”的安全值范围远远小于 Number.MAX_VALUE。</p>
<div class="language-javascript" data-ext="js" data-title="js"><pre v-pre class="language-javascript"><code>Number<span class="token punctuation">.</span><span class="token constant">MAX_SAFE_INTEGER</span> <span class="token comment">// 2^53 - 1</span>
...
</code></pre></div><p>在处理大数值整数时，可以将其转为字符串进行处理。将来 JavaScript 也许会加入对大数值的支持。</p>
<h3 id="整数检测" tabindex="-1"><a class="header-anchor" href="#整数检测"><span>整数检测</span></a></h3>
<div class="language-javascript" data-ext="js" data-title="js"><pre v-pre class="language-javascript"><code><span class="token comment">// ES6之前版本的polyfill</span>
...
</code></pre></div><h2 id="特殊数值" tabindex="-1"><a class="header-anchor" href="#特殊数值"><span>特殊数值</span></a></h2>
<p>以下内容介绍几个特殊数值：<code v-pre>undefined</code>、<code v-pre>NaN</code>、<code v-pre>正负0</code>、<code v-pre>正负无穷</code>。</p>
<h3 id="undefined与null" tabindex="-1"><a class="header-anchor" href="#undefined与null"><span>undefined与null</span></a></h3>
...
<h3 id="全局标识符undefined" tabindex="-1"><a class="header-anchor" href="#全局标识符undefined"><span>全局标识符undefined</span></a></h3>
...
<span class="token punctuation">}</span>
</code></pre></div><p><strong>永远不要重新定义 undefined。</strong></p>
<p><em>我们可以通过 <code v-pre>void 0</code> 获得undefined的值，其他 void 表达式也可以，void 0、void 1 和 undefined 之间并没有实质上的区别。</em></p>
<h3 id="特殊的数字" tabindex="-1"><a class="header-anchor" href="#特殊的数字"><span>特殊的数字</span></a></h3>
<ul>
<li>
<p>NaN</p>
<p>NaN可以理解为“无效的数值”，但它是<strong>数字类型</strong>。</p>
<div class="language-javascript" data-ext="js" data-title="js"><pre v-pre class="language-javascript"><code><span class="token keyword">var</span> nan <span class="token operator">=</span> <span class="token number">1</span> <span class="token operator">/</span> <span class="token string">'foo'</span><span class="token punctuation">;</span> <span class="token comment">// NaN</span>
<span class="token keyword">typeof</span> nan<span class="token punctuation">;</span> <span class="token comment">// 'number'</span>
</code></pre></div><p>NaN是一个特殊值，它和自身不相等，事实上，<strong>NaN不等于任何值</strong>。</p>
<div class="language-javascript" data-ext="js" data-title="js"><pre v-pre class="language-javascript"><code><span class="token number">NaN</span> <span class="token operator">===</span> <span class="token number">NaN</span><span class="token punctuation">;</span> <span class="token comment">// false</span>
</code></pre></div><p>可以通过ES6的 <code v-pre>Number.isNaN</code> 函数判断一个值是否是NaN。</p>
<div class="language-javascript" data-ext="js" data-title="js"><pre v-pre class="language-javascript"><code><span class="token comment">// polyfill</span>
...
</code></pre></div><p>JavaScript 使用有限数字表示法(finite numeric representation，即之前介绍过的 IEEE 754 浮点数)，所以和纯粹的数学运算不同，JavaScript 的运算结果有可能溢出，此时结果为 Infinity 或者 -Infinity。</p>
...
</code></pre></div><p>规范规定，如果数学运算的结果超出处理范围，则由 IEEE 754 规范中的“就近取整”(round-to-nearest)模式来决定最后的结果。</p>
...
<li>
<p>零值</p>
<p>JavaScript 有一个常规的 0 (也叫作 +0)和一个 <code v-pre>-0</code>。</p>
...
</code></pre></div><p>区分-0的方法：</p>
<div class="language-javascript" data-ext="js" data-title="js"><pre v-pre class="language-javascript"><code><span class="token keyword">function</span> <span class="token function">isNegZero</span><span class="token punctuation">(</span><span class="token parameter">n</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
...
<h3 id="特殊等式" tabindex="-1"><a class="header-anchor" href="#特殊等式"><span>特殊等式</span></a></h3>
<p>NaN 和 -0 在相等比较时的表现有些特别，我们可以用ES6的<code v-pre>Object.is</code>函数来判断。</p>
...
</code></pre></div><p>能使用 == 和 ===时就尽量不要使用 Object.is，因为前者效率更高、更为通用。</p>
<p>Object.is主要用来处理那些特殊的相等比较。</p>
<h2 id="值和引用" tabindex="-1"><a class="header-anchor" href="#值和引用"><span>值和引用</span></a></h2>
<blockquote>
