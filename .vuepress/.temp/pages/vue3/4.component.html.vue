<template><div><h1 id="component" tabindex="-1"><a class="header-anchor" href="#component"><span>component</span></a></h1>
<p>回顾之前的 patch 函数。</p>
...
<span class="token punctuation">}</span>
</code></pre></div><p>在 patch 一个 vnode 时，会根据 vnode.type 做出相应的操作。当 vnode.type 是一个对象时，这个对象描述的是一个组件。</p>
...
<span class="token punctuation">}</span>
</code></pre></div><p>一个组件对象基本结构如下，其中 render 函数是必不可少的，且 render 函数返回的应该是 vnode。</p>
<div class="language-javascript" data-ext="js" data-title="js"><pre v-pre class="language-javascript"><code><span class="token keyword">const</span> MyComponent <span class="token operator">=</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre></div><p>对于一个组件类型的 vnode 而言，也有 mountComponent 和 patchComponent 两个操作。</p>
<div class="language-javascript" data-ext="js" data-title="js"><pre v-pre class="language-javascript"><code><span class="token keyword">function</span> <span class="token function">patch</span><span class="token punctuation">(</span><span class="token parameter">n1<span class="token punctuation">,</span> n2<span class="token punctuation">,</span> container</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
  <span class="token keyword">if</span> <span class="token punctuation">(</span><span class="token keyword">typeof</span> n2<span class="token punctuation">.</span>type <span class="token operator">===</span> <span class="token string">'string'</span><span class="token punctuation">)</span> <span class="token punctuation">{</span> <span class="token comment">// 普通标签</span>
    n1
...
<span class="token punctuation">}</span>
</code></pre></div><p>这里需要注意，组件类型 vnode 和组件 render 函数返回的 vnode 是两回事。</p>
<p>在上面的例子中，<code v-pre>type=MyComponent</code> 的 vnode 是组件类型 vnode，称为组件 vnode；而 MyComponent 的 render 函数返回的是 MyComponent 的内容，以下称为 subTree。</p>
<h2 id="mountcomponent" tabindex="-1"><a class="header-anchor" href="#mountcomponent"><span>mountComponent</span></a></h2>
<p>mountComponent 的基本实现如下。</p>
...
<span class="token punctuation">}</span>
</code></pre></div><h3 id="响应系统与组件" tabindex="-1"><a class="header-anchor" href="#响应系统与组件"><span>响应系统与组件</span></a></h3>
<p>一个组件内除了 render 函数，还有组件自身的状态。</p>
<div class="language-javascript" data-ext="js" data-title="js"><pre v-pre class="language-javascript"><code><span class="token keyword">const</span> MyComponent <span class="token operator">=</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre></div><p>mountComponent 会使用响应系统实现组件状态的自更新。</p>
<div class="language-javascript" data-ext="js" data-title="js"><pre v-pre class="language-javascript"><code><span class="token keyword">function</span> <span class="token function">mountComponent</span><span class="token punctuation">(</span><span class="token parameter">vnode<span class="token punctuation">,</span> container</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span><span class="token punctuation">)</span>
<span class="token punctuation">}</span>
</code></pre></div><p>由此可见：</p>
<ul>
<li>render 函数之所以可以通过 this 获取状态，是因为 render 函数的执行上下文为 state。</li>
<li>组件的 render 和 patch 都用 effect 函数包裹，使得状态改变时，组件重新渲染。</li>
</ul>
<h3 id="组件更新调度器" tabindex="-1"><a class="header-anchor" href="#组件更新调度器"><span>组件更新调度器</span></a></h3>
<p>虽然实现了组件随状态自动更新的功能，但每次修改状态的值，都会重新渲染一次。我们可以实现一个调度器，使得无论修改多少次，都只重新渲染一次。</p>
<p>在 reactivity 一节中介绍过这个调度器，它是利用微任务的异步执行机制，实现对任务的缓冲。</p>
...
<span class="token punctuation">}</span>
</code></pre></div><p>在 effect 中使用调度器。</p>
<div class="language-javascript" data-ext="js" data-title="js"><pre v-pre class="language-javascript"><code><span class="token keyword">function</span> <span class="token function">mountComponent</span><span class="token punctuation">(</span><span class="token parameter">vnode<span class="token punctuation">,</span> container</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span><span class="token punctuation">)</span>
<span class="token punctuation">}</span>
</code></pre></div><p>目前 mountComponent 还有一个问题，调用 patch 函数时的第一个参数都是 null，这意味着每次都是全新的挂载，我们需要一个组件实例，记录上一次渲染的 subTree，然后进行打补丁操作。</p>
<h2 id="组件实例" tabindex="-1"><a class="header-anchor" href="#组件实例"><span>组件实例</span></a></h2>
<p>组件实例本质是一个对象，它维护着组件运行过程中的所有信息。它在 mountComponent 中创建。</p>
<div class="language-javascript" data-ext="js" data-title="js"><pre v-pre class="language-javascript"><code><span class="token keyword">function</span> <span class="token function">mountComponent</span><span class="token punctuation">(</span><span class="token parameter">vnode<span class="token punctuation">,</span> container</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
  <span class="token keyword">const</span> state <span class="token operator">=</span> <span class="token function">reactive</span><span class="token punctuation">(</span><span class="token function">data</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">)</span>
...
<span class="token punctuation">}</span>
</code></pre></div><p>有了组件实例，我们便可以在上面记录上一次的 subTree，从而判断组件是首次挂载或打补丁。</p>
<div class="language-javascript" data-ext="js" data-title="js"><pre v-pre class="language-javascript"><code><span class="token keyword">function</span> <span class="token function">mountComponent</span><span class="token punctuation">(</span><span class="token parameter">vnode<span class="token punctuation">,</span> container</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
  <span class="token comment">// ...</span>
  <span class="token function">effect</span><span class="token punctuation">(</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token operator">=></span> <span class="token punctuation">{</span>
    <span class="token keyword">const</span> subTree <span class="token operator">=</span> <span class="token function">render</span><span class="token punctuation">.</span><span class="token function">call</span><span class="token punctuation">(</span>state<span class="token punctuation">)</span>
...
<span class="token punctuation">}</span>
</code></pre></div><h2 id="组件生命周期" tabindex="-1"><a class="header-anchor" href="#组件生命周期"><span>组件生命周期</span></a></h2>
<p>组件是在 mountComponent 中创建和更新的，组件的生命周期就在 mountComponent 的各个位置切入。</p>
<div class="language-javascript" data-ext="js" data-title="js"><pre v-pre class="language-javascript"><code><span class="token keyword">function</span> <span class="token function">mountComponent</span><span class="token punctuation">(</span><span class="token parameter">vnode<span class="token punctuation">,</span> container</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span><span class="token punctuation">,</span> <span class="token punctuation">{</span> <span class="token literal-property property">scheduler</span><span class="token operator">:</span> queueJob <span class="token punctuation">}</span><span class="token punctuation">)</span>
<span class="token punctuation">}</span>
</code></pre></div><p>需要注意的是，执行生命周期函数时需要指定执行上下文。</p>
<h2 id="组件的-props" tabindex="-1"><a class="header-anchor" href="#组件的-props"><span>组件的 props</span></a></h2>
<p>对于一个组件来说，关于 props 有两点：</p>
<ul>
<li>组件定义的 props 选项</li>
<li>使用组件时，为组件传递的 props 数据</li>
</ul>
<p>组件定义时会显式指定组件会接收哪些数据。</p>
<div class="language-javascript" data-ext="js" data-title="js"><pre v-pre class="language-javascript"><code><span class="token keyword">const</span> MyComponent <span class="token operator">=</span> <span class="token punctuation">{</span>
...
<span class="token punctuation">}</span>
</code></pre></div><p>使用 MyComponent 时，大概会是这样的。</p>
<div class="language-html" data-ext="html" data-title="html"><pre v-pre class="language-html"><code><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>MyComponent</span> <span class="token attr-name">title</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>Vue<span class="token punctuation">"</span></span> <span class="token attr-name">:other</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>val<span class="token punctuation">"</span></span> <span class="token punctuation">/></span></span>
</code></pre></div><p>这段模板编译成 vnode 后：</p>
<div class="language-javascript" data-ext="js" data-title="js"><pre v-pre class="language-javascript"><code><span class="token keyword">const</span> vnode <span class="token operator">=</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre></div><p>可见组件定义的 props 和传递过来的 props 并不是完全对应的，我们需要解析出渲染时需要的 props 数据。</p>
...
<span class="token punctuation">}</span>
</code></pre></div><p>resolveProps 将传递给组件的值分为 props 和 attrs 返回，在组件挂载时可以使用。</p>
<div class="language-javascript" data-ext="js" data-title="js"><pre v-pre class="language-javascript"><code><span class="token keyword">function</span> <span class="token function">mountComponent</span><span class="token punctuation">(</span><span class="token parameter">vnode<span class="token punctuation">,</span> container</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span><span class="token punctuation">,</span> <span class="token punctuation">{</span> <span class="token literal-property property">scheduler</span><span class="token operator">:</span> queueJob <span class="token punctuation">}</span><span class="token punctuation">)</span>
<span class="token punctuation">}</span>
</code></pre></div><p>解析出 props 后，使其成为响应式对象，当传递的 props 数据变化时，触发组件更新。</p>
<h3 id="渲染上下文-rendercontext" tabindex="-1"><a class="header-anchor" href="#渲染上下文-rendercontext"><span>渲染上下文 renderContext</span></a></h3>
<p>上面提到过，render 函数需要访问组件的 state 和 props 数据，我们可以用代理来处理这个访问，这个代理对象称为渲染上下文，其本质是组件实例的代理。</p>
<div class="language-javascript" data-ext="js" data-title="js"><pre v-pre class="language-javascript"><code><span class="token keyword">function</span> <span class="token function">mountComponent</span><span class="token punctuation">(</span><span class="token parameter">vnode<span class="token punctuation">,</span> container</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
  <span class="token keyword">const</span> instance <span class="token operator">=</span> <span class="token punctuation">{</span>
    state<span class="token punctuation">,</span>
...
<span class="token punctuation">}</span>
</code></pre></div><p>renderContext 拦截了对 state 和 props 等数据的 get 和 set 操作，每当 render 函数或生命周期函数访问这些数据时，优先从 state 获取。</p>
<h2 id="patchcomponent" tabindex="-1"><a class="header-anchor" href="#patchcomponent"><span>patchComponent</span></a></h2>
<p>回顾 patch 函数，更新组件调用的是 patchComponent 函数。</p>
<div class="language-javascript" data-ext="js" data-title="js"><pre v-pre class="language-javascript"><code><span class="token keyword">function</span> <span class="token function">patch</span><span class="token punctuation">(</span><span class="token parameter">n1<span class="token punctuation">,</span> n2<span class="token punctuation">,</span> container</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre></div><p>当组件的 props 数据变化时，我们首先需要判断 props 是否真的有更新。</p>
<div class="language-javascript" data-ext="js" data-title="js"><pre v-pre class="language-javascript"><code><span class="token keyword">function</span> <span class="token function">hasPropsChanged</span><span class="token punctuation">(</span><span class="token parameter">prevProps<span class="token punctuation">,</span> nextProps</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
...
<span class="token punctuation">}</span>
</code></pre></div><p>如果有更新，则更新 props 并删除旧的 props。</p>
<div class="language-javascript" data-ext="js" data-title="js"><pre v-pre class="language-javascript"><code><span class="token keyword">function</span> <span class="token function">patchComponent</span><span class="token punctuation">(</span><span class="token parameter">n1<span class="token punctuation">,</span> n2<span class="token punctuation">,</span> container</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
