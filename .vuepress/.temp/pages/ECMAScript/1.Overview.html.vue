...
<td style="text-align:center">Identifier, Literal</td>
</tr>
<tr>
<td style="text-align:center">Expression</td>
<td style="text-align:center">Atom, Operator, Punctuator</td>
</tr>
<tr>
<td style="text-align:center">Statement</td>
<td style="text-align:center">Expression, Keyword, Punctuator</td>
</tr>
<tr>
<td style="text-align:center">Structure</td>
<td style="text-align:center">Function, Class, Process, Namespace, ...</td>
</tr>
<tr>
<td style="text-align:center">Program</td>
<td style="text-align:center">Program, Module, Package, Library</td>
</tr>
</tbody>
</table>
<p>下面通过这 7 个层级分析 ECMAScript。</p>
</div></template>
