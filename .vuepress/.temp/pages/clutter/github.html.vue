<template><div><h1 id="github" tabindex="-1"><a class="header-anchor" href="#github"><span>github</span></a></h1>
<p>github 除了 git 管理代码仓库的能力，还提供了一些额外的功能。</p>
<ul>
<li>Github Actions，用于 CI / CD</li>
<li>Github Packages，发布 NPM 包等</li>
<li>Github Pages，发布静态页面</li>
<li>Github Codespaces，线上代码开发</li>
<li>Github Gist，记录代码片段</li>
</ul>
<p><a href="https://docs.github.com/" target="_blank" rel="noopener noreferrer">github docs<ExternalLinkIcon/></a> 中对这些功能都有详细介绍。</p>
<h2 id="github-actions" tabindex="-1"><a class="header-anchor" href="#github-actions"><span>github actions</span></a></h2>
<p>github actions 可以设置你的 github 工作流，主要用于 CI / CD。</p>
<ul>
<li>持续集成 ( Continuous Integration, CI )，将代码集成到共享代码仓库，并自动化构建、测试和验证。</li>
<li>持续部署 ( Continuous Deployment, CD )，在 CI 的基础上，将代码自动交付到生产环境。</li>
</ul>
<p>下面是一个使用 vuepress 的博客仓库的工作流设置。</p>
<div class="language-yaml" data-ext="yml" data-title="yml"><pre v-pre class="language-yaml"><code><span class="token key atrule">name</span><span class="token punctuation">:</span> build my blog
...
</code></pre></div><p>工作流设置中经常见到类似 <code v-pre>uses: actions/checkout@v3</code> 的设置，这是官方提供的预设，它们都存放在 <a href="https://github.com/actions" target="_blank" rel="noopener noreferrer">github 官方账号<ExternalLinkIcon/></a>中。</p>
<h2 id="github-packages" tabindex="-1"><a class="header-anchor" href="#github-packages"><span>github packages</span></a></h2>
<p>首先明确 npm registry 的概念，npm、yarn、pnpm 等包管理工具下载 npm 包，默认 registry 都是 npm 官方提供的仓库，github 也提供了类似的仓库。此外还有其他镜像库，它们都是 npm registry。</p>
<ul>
<li>npm 官方仓库： https://registry.npmjs.org</li>
<li>github package 仓库：https://npm.pkg.github.com</li>
<li>其他 npm 仓库镜像：https://registry.npmmirror.com</li>
</ul>
<p>当然，无论是什么仓库，我们发布的都是 npm 包 ( 用 package.json 描述 )。</p>
<p>以下是发布 npm 包到 github package 的工作流设置。</p>
<div class="language-yaml" data-ext="yml" data-title="yml"><pre v-pre class="language-yaml"><code><span class="token comment"># For more information see: https://docs.github.com/en/actions/publishing-packages/publishing-nodejs-packages</span>
...
</code></pre></div><p>值得注意的是 git tag 和 github release 的区别。</p>
<p>tag 是 git 的概念，github 理所当然的也有 tag；但 release 是 github 提出的概念，主要是方便用户发布版本，版本中通常有 changelog 等信息，<strong>发布一个 release 需要指定一个 tag</strong>。</p>
<h2 id="github-as-picbed" tabindex="-1"><a class="header-anchor" href="#github-as-picbed"><span>github as picbed</span></a></h2>
<p>一个 github repository 除了可以存放代码之外，还可以专门用来存储图片。</p>
<p>创建名为 pic-bed ( 名称任意 ) 的 repository，提交 photo.png 到 master 分支，然后可以通过以下地址访问到该图片。</p>
<div class="language-text" data-ext="text" data-title="text"><pre v-pre class="language-text"><code>https://raw.githubusercontent.com/yamsfeer/pic-bed/master/photo.png
